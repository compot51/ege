#  Формат вывода:
#  Первая строка:     три числа из ввода (время захода, время решения вопроса, приоритет очереди),
#                     время завершения решения вопроса, ПРОПУСК, если человек ушел из-за больших очередей
#  Вторая строка:     очередь А - список людей в очереди, определяемых по времени окончания
#  Третья строка:     очередь В - ан-но
#  Четвертая строка:  строка разделения
